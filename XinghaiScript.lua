...
Notify("星海脚本", "作者小鸟游星野", "rbxassetid://116781696346876", 3)
Notify("永久免费", "祝你玩的开心！","rbxassetid://116781696346876",3)
Notify("永久免费", "拒绝圈钱","rbxassetid://116781696346876",3)
Notify("呜嘿～", "新脚本请大家多多支持","rbxassetid://    116781696346876",3)
Notify("拒绝圈钱", "拒绝倒卖","rbxassetid://116781696346876",3)
Notify("启动完成", "祝你玩的开心","rbxassetid://116781696346876",5)

local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/woshixiaoheizijieshuo/xinghaiUI/refs/heads/main/XinghaiUI.lua'))()
local Window = Library:new("星海脚本");

local creds = Window:Tab("公告",'88328893266410')
local bin = creds:section("信息",true)
local about = creds:section("作者",true)

local Main = Window:Tab("主要",'88328893266410')
...
local JSDGt = Window:Tab("驾驶帝国",'88328893266410')
local JSDG = JSDGt:section("自动&刷钱",true)

local FMDHt = Window:Tab("伐木大亨2",'88328893266410')
local FMDH = FMDHt:section("伐木大亨2",true)

local SKQSt = Window:Tab("鲨口求生2",'88328893266410')
local SKQS = SKQSt:section("鲨口&求生",true)

local DoorsT = Window:Tab("doors",'88328893266410')
local Doors = DoorsT:section("通用&功能",true)
local DOORSR = DoorsT:section("透视",true)
local BP = DoorsT:section("其他",true)

local LLCQt = Window:Tab("力量传奇",'88328893266410')
...
local ZDYSt = Window:Tab("战斗勇士",'88328893266410')
local ZDYS = ZDYSt:section("主要",true)

local HBTXt = Window:Tab("河北唐县",'88328893266410')
local HBTX = HBTXt:section("主的",true)
local HBXT = HBTXt:section("传送位置",true)

local ZRZHt = Window:Tab("自然灾害",'88328893266410')
local ZRZH = ZRZHt:section("自然&灾害",true)
local RHE = ZRZHt:section("玩家",true)

local EVt = Window:Tab("Evade",'88328893266410')
local EV = EVt:section("Evade",true)

local XGt = Window:Tab("实用功能",'88328893266410')
local XG = XGt:section("实用功能",true)
local GN = XGt:section("实用工具",true)

local OSCt = Window:Tab("其他脚本",'88328893266410')
local OSC = OSCt:section("通用脚本",true)

local SIJt = Window:Tab("视觉",'88328893266410')
...
local EN = Window:Tab("作者通告",'88328893266410')
local NE = EN:section("玩家公告!",true)

local VT = Window:Tab("其他注入器",'88328893266410')
local YV = VT:section("输入器整合",true)

local OH = Window:Tab("火箭发射模拟",'88328893266410')
local HO = OH:section("主要",true)
local HQ = OH:section("传送位置",true)

local UR = Window:Tab("超级大力士",'88328893266410')
local RU = UR:section("主要的",true)
local OR = UR:section("其他",true)
local QS = UR:section("位置传送",true)

local OSQ = Window:Tab("战争大亨",'88328893266410')
...
bin:Label("账号年龄:"..game.Players.LocalPlayer.AccountAge.."天")
bin:Label("客户端id:"..game:GetService("RbxAnalyticsService"):GetClientId())
bin:Label("服务器名称:"..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name)

about:Label("作者小鸟游星野")
about:Label("作者QQ:1336215629")
about:Label("脚本QQ群:RBX-蔚蓝档案交流群")
about:Label("辅助作者:小零")
about:Label("QQ脚本交流频道:XHScriptNB666")
about:Label("作者抖音:我是小黑子解说")
about:Label("正在继续制作")
about:Label("请勿倒卖或圈钱")
about:Button("复制作者QQ", function()
    setclipboard("1336215629")
end)
about:Button("复制辅助作者QQ", function()
    setclipboard("1707182940")
end)
about:Button("复制QQ群", function()
    setclipboard("537213004")
end)
about:Button("复制脚本交流频道", function()
    setclipboard("XHScriptNB666")
end)
about:Button("复制作者抖音", function()
    setclipboard("woshiheizijie")
end)
...
NE:Label("已完结")
NE:Label("我们分了好几个人，但是制作不易还是希望多多支持")
NE:Label("此脚本是缝合希望大家说的话手下留情")
NE:Label("因为技术有限功能比较少")
NE:Label("主要的基本都有，没有的话可以提意见")
NE:Label("再次感谢你的支持")
NE:Label("谢谢您")
NE:Label("谢谢您使用了我们的脚本")
NE:Label("俄亥俄州有可能用不了，以后会出单独的一个脚本")
